...
class BertSpamClassifier(AbstractSpamClassifier):
    ...
    @staticmethod
    def get_name() -> str:
        return 'BertSpamClassifier (mrm8488/bert-tiny-finetuned-sms-spam-detection)'
    ...
    # Override
    @property
    def max_input_length(self) -> int: return 512